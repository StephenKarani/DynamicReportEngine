...
import com.onlinehubsolutions.DynamicReportEngine.connection.SQLDatabaseConnection;
import com.onlinehubsolutions.DynamicReportEngine.engine.SqlReportGenerator;
import com.onlinehubsolutions.DynamicReportEngine.model.ReportEngineModel;

@Repository("sqlDao")
public class GenerateSQLReports implements ReportEngineDao {
    ...
    public String generateReport(ReportEngineModel reportEngineModel) {
		SqlReportGenerator reportGenerator = new SqlReportGenerator();
